...
// Hand-authored multi-line trend chart -- same "small authored SVG" approach
// as DonutChart.tsx rather than pulling in a charting library for one
// admin-only screen. Renders a fixed number of evenly-spaced points along
// the x-axis (the caller supplies one value per day) with a light grid and
// no interactivity, which is enough for a 30-day glance.
